        ...
        <header class="header fixed-top clearfix">
            ...
            <div class="top-nav clearfix">
                ...
                <ul class="nav pull-right top-menu">
                    <li>
                        <form action="{{URL('/search/{key}')}}" method="">
                        <input type="text" class="form-control search" name="keyw" placeholder=" Search">
                        </form>
                    </li>
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">Đức Anh</span>
                            <b class="caret"></b>
                        </a>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::TO('/add-category-room')}}">Thêm danh mục phòng</a></li>
                                <li><a href="{{URL::TO('/all-category-room')}}">Liệt kê danh mục phòng</a></li>
                            </ul>
                        </li> 
                         <li class="sub-menu">
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© WEBSITE DESIGN HOTEL | Design by <a href="https://www.facebook.com/profile.php?id=100022076710483">ANHBUIDUC</a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>
